    ...
    <main class="content-container">
        <section class="flex section one-container container">
            <div class="section-row flex one one-text">
                ...
                <a href="#"><button class="one-cta light-cta">Check Out My Creations</button></a>
            </div>
        ...
        <section class="flex section two-container container">
            <div class="section-row two flex">
                <div class="two-text">
                    ...
                    <a href="#"><button class="two-cta light-cta">Explore my Journey</button></a>
                </div>
                <img class="two-img" src="images/young-handsome-african-man-with-crossed-arms-blue-wall.png" alt="">
            </div>
        </section>
